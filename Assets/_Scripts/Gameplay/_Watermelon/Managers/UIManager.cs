...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (gameManager != null)
        {
            //restartButton.onClick.AddListener(gameManager.ReturnToMenu);
            //quitButton.onClick.AddListener(gameManager.QuitGame);
            if (gameOverRestartButton != null) gameOverRestartButton.onClick.AddListener(gameManager.ReturnToMenu);
            if (gameOverMenuButton != null) gameOverMenuButton.onClick.AddListener(gameManager.ReturnToMenu);
        }
        ...
        CloseAllItemPanels();
        if (tipText != null) tipText.gameObject.SetActive(false); // 默认隐藏提示
